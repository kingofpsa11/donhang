...
@section('form-content')
    <div class="form-group">
        ...
        <select class="form-control category" style="width: 100%;" name="product[0][category_id]" required>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="product[0][code]">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <textarea id="" class="form-control" name="product[0][note]"></textarea>
    </div>
