...
@section('content')
        ...
        <div class="box-body table-responsive">
            <table id="example1" class="table table-bordered table-striped table-condensed">
                ...
                <tr>
                    ...
                    <th class="text-center">Bản vẽ</th>
                ...
                @foreach ($manufacturerOrder->manufacturerOrderDetails as $manufacturerOrderDetail )
                    <tr data-key="{{ $loop->index }}">
                        ...
                        <td data-col-seq="6">
                            @foreach($manufacturerOrderDetail->contractDetail->price->product->images as $image)
    ...
    @include('shared._modal', [
       ...
       'modelName' => 'Lệnh sản xuất',
       'modelInformation' => $manufacturerOrder->number,
       'routeName' => 'manufacturer-orders'
    ])
@endsection
