...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <header class="main-header">
        ...
        <!-- Logo -->
        <a href="#" class="logo hide-on-landscape">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{ route('manufacturer-notes.create') }}"><i class="fa fa-circle-o"></i>Phiếu tạo phôi</a></li>
                        <li><a href="{{ route('shape-notes.create') }}"><i class="fa fa-circle-o"></i>Phiếu cắt tấm</a></li>
