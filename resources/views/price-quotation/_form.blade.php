                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <select class="form-control select2 customer" name="customer_id" id="selectCustomer" style="width: 100%" required>
                                @if (isset($priceQuotation))
                                    <option value="{{ $priceQuotation->customer_id }}">{{ $priceQuotation->customer->name }}</option>
                                @endif
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Nhập số báo giá ..." name="number" value="{{ $newNumber ?? $priceQuotation->number}}" readonly>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" value="{{ $priceQuotation->date ?? date('d/m/Y') }}" name="date" required>
                            </div>
                            <!-- /.input group -->
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Giá trị báo giá</label>
                            <input type="text" class="form-control currency" readonly name="total_value" value="{{ $priceQuotation->total_value ?? ''}}">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    $.get(
                        ...
                        function (result) {
                            if (result > 0 && window.location.pathname.indexOf('create') >= 0) {
                                numberObj.parent().find('span').html('Đã tồn tại số báo giá');
